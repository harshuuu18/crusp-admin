  ...
  return (
    <div className="sidenav">
      ...
      <div className="nav-items">
         ...
         <NavLink className="nav-links" to="/program" activeClassName="active"> <img src={iprogram} height="20px"/>My Program  </NavLink>
         <NavLink  className="nav-links" to="/live">
         <img src={ilive} height="20px"/> Join Live
         </NavLink>
         <NavLink className="nav-links" to="/billing"> <img src={ibill} height="20px"/> Billing</NavLink>
      </div>
